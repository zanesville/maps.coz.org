...
class Map {
  constructor(opts) {
    ...
    (this._preserveDrawingBuffer = true),
      (this._mbToken =
        "pk.eyJ1IjoiY296Z2lzIiwiYSI6ImNrNHloMzJwdDAwajYza3BhZWdwcGttNGwifQ.M87K4AluzE_Ijzda7CJgTw");
            ...
            if (plcode.coords) {
              e.flyTo({
                ...
                popup(
                  ...
                  getFeatures(
                    e,
                    { lngLat: [plcode.coords.longitudeCenter, plcode.coords.latitudeCenter] },
                    ids
                  )
                );
              });
